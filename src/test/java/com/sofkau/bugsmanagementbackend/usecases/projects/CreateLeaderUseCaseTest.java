...
@SpringBootTest
public class CreateLeaderUseCaseTest {

    private CreateLeaderUseCase useCase;
    ...
    @BeforeEach
    void setUp(){
        useCase = new CreateLeaderUseCase(repository, mapper);
    }

    @Test
    void createLeaderTest(){
        //Set a project
        ...
        project.setLeaderEmails(new HashSet<String>(List.of("leader@gmail.com")));
        ...
        projectUpdated.setLeaderEmails(new HashSet<>(List.of("leader@gmail.com", "leader1@gmail.com")));
        ...
        StepVerifier.create(monoProject)
                .assertNext(projectDTO -> Assertions.assertEquals(2, projectDTO.getLeaderEmails().size()))
                .expectNextCount(1)
                .expectComplete();
